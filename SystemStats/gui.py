...
button1.grid(row=1, column=0, pady=1,padx=1)
# cpu
button2 = ttk.Button(window, text='Cpu',
                     width=10, command=display2)
button2.grid(row=3, column=0, pady=1,padx=1)
# graph
button3 = ttk.Button(window, text='Graph',
                     width=10, command=display3)
button3.grid(row=5, column=0, pady=1,padx=1)
# box to display output
output = Text(window, width=60, height=6, wrap=WORD,
